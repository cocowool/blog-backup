...
tag: 
keywords: kubernetes, kubeadm, docker
description: 本文介绍如何通过kubeadm进行kubernetes集群的安装和配置。
---
...
![](./2018-07-24-kubeadm_install_kubernetes/39469-20180710163655709-89635310.png)
