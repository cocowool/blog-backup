...
1958年，达尔在奥斯陆大学获得数值数学硕士学位。

1960年，尼加德成为挪威计算中心的研究主任，并于1961年邀请达尔参与一个编程语言项目。

达尔和尼加德设计了两种语言：Simula I，勇于模拟；Simula 67，一种通用语言。作为最早的面向对象编程语言，Simula I 和 Simula 67 将数据和相关操作封装起来，使得只有操作对外公开课访问，而数据结构的内部细节被隐藏。这种编程方法为后来许多主流语言（如C++、Java 和 C#）奠定了基础。
