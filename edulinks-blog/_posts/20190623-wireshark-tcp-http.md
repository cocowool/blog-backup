...
Display Filter 是工具栏下面的搜索框，左边是一个收藏夹图标，右边是一个搜索按钮和加号。

![image-20250827213420948](20190623-wireshark-tcp-http/image-20250827213420948.png)

通过在搜索栏中输入过滤条件，就可以快速的查找流量包中的内容。
...
点击图标栏的搜索图标，提供了按照字符串查询流量内容的方式，对于我们想要找到一些关键字符信息所在的请求非常有帮助。

![image-20250827080817847](20190623-wireshark-tcp-http/image-20250827080817847.png)
